        ...
        success: function(response) {
            try {
                ...
                if (res.status === 'success') {
                    // Simpan gambar setelah asesmen berhasil disimpan
                    $.ajax({
                        ...
                        success: function(imageResponse) {
                            try {
                                ...
                                if (imgRes.status === 'success') {
                                    ...
                                    loadAsesmenMedisAnakData(); // Muat ulang data asesmen termasuk gambar
                                } else {
                    ...
                    $('#asesmenMedisAnakForm')[0].reset(); // Reset form setelah berhasil menyimpan data
